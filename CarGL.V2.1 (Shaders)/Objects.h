...
public: // Atributos de la clase
		...
		int     num_vertices6;   // número de vértices

        float   *modelo7;        // modelo a representar
		int     num_vertices7;   // número de vértices

        float   *modelo8;        // modelo a representar
		int     num_vertices8;   // número de vértices

        float   *modelo9;        // modelo a representar
		int     num_vertices9;   // número de vértices

		float   *modelo10;        // modelo a representar
		int     num_vertices10;   // número de vértices

		float   *modelo11;        // modelo a representar
		int     num_vertices11;   // número de vértices

		float   *modelo12;        // modelo a representar
		int     num_vertices12;   // número de vértices

		float   *modelo13;        // modelo a representar
		int     num_vertices13;   // número de vértices

		float   *modelo14;        // modelo a representar
		int     num_vertices14;   // número de vértices

		float   *modelo15;        // modelo a representar
		int     num_vertices15;   // número de vértices

		float   *modelo16;        // modelo a representar
		int     num_vertices16;   // número de vértices

		float   *modelo17;        // modelo a representar
		int     num_vertices17;   // número de vértices

		float   *modelo18;        // modelo a representar
		int     num_vertices18;   // número de vértices

        float   *modelo19;        // modelo a representar
		int     num_vertices19;   // número de vértices

		float   *modelo20;        // modelo a representar
		int     num_vertices20;   // número de vértices

        float   *modelo21;        // modelo a representar
		int     num_vertices21;   // número de vértices

        float   *modelo22;        // modelo a representar
		int     num_vertices22;   // número de vértices


        float   *modelo23;        // modelo a representar
		int     num_vertices23;   // número de vértices


        float   *modelo24;        // modelo a representar
		int     num_vertices24;   // número de vértices


        float   *modelo25;        // modelo a representar
		int     num_vertices25;   // número de vértices


        float   *modelo26;        // modelo a representar
		int     num_vertices26;   // número de vértices

		float   *modelo27;        // modelo a representar
		int     num_vertices27;   // número de vértices

		float   *modelo28;        // modelo a representar
		int     num_vertices28;   // número de vértices

		float   *modelo29;        // modelo a representar
		int     num_vertices29;   // número de vértices

		float   *modelo30;        // modelo a representar
		int     num_vertices30;   // número de vértices

		float   *modelo31;        // modelo a representar
		int     num_vertices31;   // número de vértices

        float   *modelo32;        // modelo a representar
		int     num_vertices32;   // número de vértices

        float   *modelo33;        // modelo a representar
		int     num_vertices33;   // número de vértices

		 float   *modelo34;        // modelo a representar
		int     num_vertices34;   // número de vértices

		 float   *modelo35;        // modelo a representar
		int     num_vertices35;   // número de vértices

		 float   *modelo36;        // modelo a representar
		int     num_vertices36;   // número de vértices

		 float   *modelo37;        // modelo a representar
		int     num_vertices37;   // número de vértices
