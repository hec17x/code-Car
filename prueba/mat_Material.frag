...
in vec3 var0;
const mat4 cons2 = mat4(1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000);
const vec3 cons3 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons4 = vec3(1.000000, 1.000000, 1.000000);
const float cons5 = float(0.000000);
const float cons6 = float(0.000000);
uniform sampler2D samp0;
const float cons15 = float(0.000000);
in vec3 varnormal;
const vec4 cons19 = vec4(0.000000, 0.000000, 0.000000, 1.000000);
...
void main()
{
	...
	node_bsdf_diffuse(tmp13, cons15, facingnormal, tmp17);
	node_output_material(tmp17, cons19, cons20, tmp21);
	linearrgb_to_srgb(tmp21, tmp23);
